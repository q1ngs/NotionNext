...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '信息安全爱好者, 伪文学爱好者, 普普通通打工人,欢迎来到我的博客🎉',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客, 信息安全, IOT安全, 随笔', // 网站关键词 英文逗号隔开
